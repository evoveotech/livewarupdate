...
const baseUrl = BRAND.siteUrl || 'https://www.worldmonitor.app/';
const baseSiteName = BRAND.siteName || 'World Monitor';
const baseTitle = BRAND.appTitle || 'World Monitor - Real-Time Global Intelligence Dashboard';
// When using custom domain (BRAND.siteUrl set), all variants use same URL
const useCustomDomain = Boolean(BRAND.siteUrl);
...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  tech: {
    ...
    url: useCustomDomain ? baseUrl : 'https://tech.worldmonitor.app/',
  ...
  happy: {
    ...
    url: useCustomDomain ? baseUrl : 'https://happy.worldmonitor.app/',
  ...
  finance: {
    ...
    url: useCustomDomain ? baseUrl : 'https://finance.worldmonitor.app/',
  ...
  commodity: {
    ...
    url: useCustomDomain ? baseUrl : 'https://commodity.worldmonitor.app/',
